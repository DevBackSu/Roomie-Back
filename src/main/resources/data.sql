...
INSERT INTO Post(post_id, user_id, title, content, write_dtm)
...
INSERT INTO Post(post_id, user_id, title, content, write_dtm)
VALUES(4,1, '세상에서','id = 4', now());
INSERT INTO Post(post_id, user_id, title, content, write_dtm)
VALUES(5,1, '제일 가는','id = 5', now());
INSERT INTO Post(post_id, user_id, title, content, write_dtm)
VALUES(6,1, '포테이토','id = 6', now());
INSERT INTO Post(post_id, user_id, title, content, write_dtm)
VALUES(7,1, '칩','id = 7', now());
INSERT INTO Post(post_id, user_id, title, content, write_dtm)
VALUES(8,1, '야호','아 귀찮아', now());
INSERT INTO Post(post_id, user_id, title, content, write_dtm)
VALUES(9,1, '야나두','으아아악', now());
INSERT INTO Post(post_id, user_id, title, content, write_dtm)
VALUES(10,1, '안들려','이게 뭐지', now());
INSERT INTO Post(post_id, user_id, title, content, write_dtm)
VALUES(11,1, '다음','페이지여야 함', now());
